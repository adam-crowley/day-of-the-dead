...
function Header() {
  return (
    <header className="flex flex-wrap justify-center py-10 bg-dd-dark-purple bg-gradient-to-b from-transparent from-40% to-dd-light-purple/30">
      <Link to="/" className="flex header__link">
        <img
          src="/images/skull.png"
          alt="skull"
          className="self-center w-[300px] mr-8"
        />
        <h1 className="flex flex-col justify-center text-left font-serif italic text-7xl text-dd-yellow">
